...
- 核心框架
  ...
  - Spring Web / Validation / Data JPA / Security / OAuth2 Resource Server: 跟随 Spring Boot `3.4.5` 版本管理
  - Spring Security OAuth2 JOSE: 跟随 Spring Boot `3.4.5` 版本管理
  - Freemarker: 跟随 Spring Boot `3.4.5` 版本管理
- 数据库与驱动
  - H2: runtime 依赖（版本由 Spring Boot `3.4.5` 管理）
  - MySQL Connector/J: runtime 依赖（版本由 Spring Boot `3.4.5` 管理）
- 鉴权与令牌
